...
- `CLIMATE_FRONTEND_CLIENT_ID` - The client ID of the Keycloak client that climate-frontend will use
- `CLIMATE_FRONTEND_CLIENT_SECRET` - The client secret of the Keycloak client that climate-frontend will use
- `CLIMATE_FRONTEND_DOMAIN` - The domain that the climate-frontend application is running on. This is used to configure the redirect URI of the Keycloak client.
