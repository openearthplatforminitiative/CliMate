	...
	return (
		<>
			...
			<main>
				<div className="relative flex flex-col lg:h-[80vh] w-full bg-primary-20">
					<div className="flex flex-col justify-center max-w-[1350px] lg:h-full h-[80vh] px-10 mx-auto w-full">
						...
						<p className="flex flex-col gap-2 text-xl sm:text-3xl text-secondary-98">
							Saving our planet
							<span className="w-min bg-primary-30 border-r-4 p-2 !border-primary-40">
								together
							</span>
						</p>
						<div className="mt-5">
					...
					<div
						className={`relative lg:absolute w-full lg:w-1/3 h-96 lg:h-full lg:right-0`}
					>
						<Image
				...
				<div
					className={`flex flex-col-reverse lg:flex-row bg-primary-20 lg:py-32 text-secondary-98`}
				>
					...
					<div className="flex flex-col py-32 max-w-[1000px] justify-center h-full px-10">
						...
						<p className="text-xl sm:text-2xl">
							CliMate is an open platform initiative to report all kinds of
							climate related issues, and a collaborate way to save and support
							our earth.
						</p>
					</div>
				</div>
			...
			<footer className="flex bg-primary-10 py-16 text-secondary-98">
				<div className="flex flex-col justify-center max-w-[1350px] h-full px-10 mx-auto w-full">
					<h2 className="font-[newsreader] text-5xl mb-5 sm:mb-10">Partners</h2>
				</div>
			</footer>
		</>
	)
