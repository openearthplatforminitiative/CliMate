  ...
  return (
    <>
      ...
      <div className={`flex flex-col-reverse lg:flex-row bg-primary-20 lg:py-32 text-secondary-98`}>
        ...
        CliMate is an open platform initiative to report all kinds of climate related issues, and a collaborate way to
        save and support our earth.
        </p>
        </div>
      </div>
      <div className="flex bg-secondary-40 py-16 text-secondary-98">
        <div className="flex flex-col justify-center max-w-[1350px] h-full px-10 mx-auto w-full">
          ...
          <p className="text-xl sm:text-2xl">Events is arranged by organizations or private persons to clean up areas</p>
        </div>
      </div>
