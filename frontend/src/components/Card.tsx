...
export const ProjectCard = ({title, description, date}: ProjectCardProps) => {
	return (
		<div className="flex flex-col min-w-52 aspect-square bg-secondary-50 hover:bg-secondary-60 rounded-2xl overflow-hidden cursor-pointer">
			<div className="relative grow h-full">
				<Image src="/river.jpg" alt={"test"} className="object-cover" fill/>
				{date && (
